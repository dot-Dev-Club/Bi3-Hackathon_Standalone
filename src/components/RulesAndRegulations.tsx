      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-6xl mx-auto">
          {rules.map((rule, index) => (
            ...
            >
              <div className="rounded-2xl p-6 h-full bg-white/10 backdrop-blur-2xl border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.1)] hover:bg-white/15 hover:border-white/30 hover:shadow-[0_8px_32px_rgba(0,0,0,0.15)] transition-all duration-500">
